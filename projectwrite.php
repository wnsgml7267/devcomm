            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="contact-form-area">
                        <form action="_projectwrite.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="form-control">언어를 선택해주세요.
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="form-control">모집군을 선택해주세요 : 
                                            <select name="field">
                                                <option value="서버개발자">서버개발자</option>
